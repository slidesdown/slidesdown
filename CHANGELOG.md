...
- Prevent deletion of reveal.js plugin

## [1.4.1] - 2026-04-20

### Features

- Update decktape to version 3.16.1
...
- Fix removal of analytics in docker container and this and other Dockerfile elements
